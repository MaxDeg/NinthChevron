...
namespace NinthChevron.Data.MySql.Metadata
{
    public class MySqlProcedure : IProcedureMetadata
    {
        public MySqlProcedure(IDatabaseMetadata dbMetadata, string schema, string name)
        {
